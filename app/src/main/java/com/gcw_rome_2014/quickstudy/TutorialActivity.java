...
import com.gcw_rome_2014.quickstudy.custom.CustomPagerAdapter;
...
public class    TutorialActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkFirstExecution();
        setContentView(com.gcw_rome_2014.quickstudy.R.layout.activity_tutorial);
        viewPager = (ViewPager) findViewById(com.gcw_rome_2014.quickstudy.R.id.viewPager);
        startButton = (Button) findViewById(com.gcw_rome_2014.quickstudy.R.id.start_button);
